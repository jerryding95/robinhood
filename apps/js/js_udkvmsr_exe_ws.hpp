#ifndef __js_udkvmsr_exe_ws_H__
#define __js_udkvmsr_exe_ws_H__

namespace js_udkvmsr_exe_ws {
    ...
    constexpr EventSymbol js__receiver_claim_work = 60;
    constexpr EventSymbol js__receiver_set_terminate_bit = 61;
    constexpr EventSymbol js__receiver_set_terminate_bit_ret = 62;
    constexpr EventSymbol js__receiver_receive_intermediate_kv_pair = 63;
    constexpr EventSymbol js__receiver_fetched_kv_ptr_for_cache = 64;
    constexpr EventSymbol js__receiver_materialize_ret = 65;
    constexpr EventSymbol js__receiver_update_unresolved_kv_count = 66;
    constexpr EventSymbol js__receiver_acknowledge_key_executed = 67;
    constexpr EventSymbol js__mapper_control_init = 68;
    constexpr EventSymbol js__mapper_control_read_partition = 69;
    constexpr EventSymbol js__mapper_control_get_next_return = 70;
    constexpr EventSymbol js__mapper_control_loop = 71;
    constexpr EventSymbol js__lane_remote_mapper_finished = 72;
    constexpr EventSymbol js__kv_map = 73;
    constexpr EventSymbol js__map_v1_read_ret = 74;
    constexpr EventSymbol js__map_v2_read_ret = 75;
    constexpr EventSymbol js__kv_reduce = 76;
    constexpr EventSymbol js__sp_malloc_ret = 77;
    constexpr EventSymbol js_compute__setup_thread_reg = 78;
    constexpr EventSymbol js_compute__v1_nblist_read_ret = 79;
    constexpr EventSymbol js_compute__v2_nblist_read_ret = 80;
    constexpr EventSymbol js_compute__intersect_ab = 81;
    constexpr EventSymbol js_compute__intersect_term = 82;
    constexpr EventSymbol js_compute__sp_free_ret = 83;
    constexpr EventSymbol main__init = 84;
    constexpr EventSymbol main__combine_js = 85;
    constexpr EventSymbol main__term = 86;
    constexpr EventSymbol main_broadcast_init__setup_spd = 87;
    constexpr EventSymbol Broadcast__broadcast_global = 88;
    constexpr EventSymbol Broadcast__broadcast_node = 89;
    constexpr EventSymbol Broadcast__broadcast_ud = 90;
    constexpr EventSymbol Broadcast__broadcast_ud_fin = 91;
    constexpr EventSymbol Broadcast__broadcast_node_fin = 92;
    constexpr EventSymbol Broadcast__broadcast_global_fin = 93;
    constexpr EventSymbol Broadcast__broadcast_value_to_scratchpad = 94;
