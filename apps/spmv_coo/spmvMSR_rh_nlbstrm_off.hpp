#ifndef __spmvMSR_rh_nlbstrm_off_H__
#define __spmvMSR_rh_nlbstrm_off_H__

namespace spmvMSR_rh_nlbstrm_off {
    ...
    constexpr EventSymbol spmv__worker_confirm_local_materialized_count = 67;
    constexpr EventSymbol spmv__worker_confirm_materialized_count = 68;
    constexpr EventSymbol spmv__receiver_claim_work = 69;
    constexpr EventSymbol spmv__receiver_set_terminate_bit = 70;
    constexpr EventSymbol spmv__receiver_set_terminate_bit_ret = 71;
    constexpr EventSymbol spmv__receiver_receive_intermediate_kv_pair = 72;
    constexpr EventSymbol spmv__receiver_fetched_kv_ptr_for_cache = 73;
    constexpr EventSymbol spmv__receiver_materialize_ret = 74;
    constexpr EventSymbol spmv__receiver_update_unresolved_kv_count = 75;
    constexpr EventSymbol spmv__receiver_acknowledge_key_executed = 76;
    constexpr EventSymbol spmv__receiver_check_materialized_count = 77;
    constexpr EventSymbol spmv__mapper_control_init = 78;
    constexpr EventSymbol spmv__mapper_control_read_partition = 79;
    constexpr EventSymbol spmv__mapper_control_get_next_return = 80;
    constexpr EventSymbol spmv__mapper_control_loop = 81;
    constexpr EventSymbol spmv__lane_remote_mapper_finished = 82;
    constexpr EventSymbol updown_init = 83;
    constexpr EventSymbol set_vector_ptr = 84;
    constexpr EventSymbol msr_init = 85;
    constexpr EventSymbol spmv__kv_map = 86;
    constexpr EventSymbol kv_map_calc = 87;
    constexpr EventSymbol updown_terminate = 88;
