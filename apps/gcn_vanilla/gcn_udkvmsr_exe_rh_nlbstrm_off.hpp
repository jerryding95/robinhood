#ifndef __gcn_udkvmsr_exe_rh_nlbstrm_off_H__
#define __gcn_udkvmsr_exe_rh_nlbstrm_off_H__

namespace gcn_udkvmsr_exe_rh_nlbstrm_off {
    ...
    constexpr EventSymbol gnn_vanilla_kvmsr__worker_confirm_local_materialized_count = 53;
    constexpr EventSymbol gnn_vanilla_kvmsr__worker_confirm_materialized_count = 54;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_claim_work = 55;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_set_terminate_bit = 56;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_set_terminate_bit_ret = 57;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_receive_intermediate_kv_pair = 58;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_fetched_kv_ptr_for_cache = 59;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_materialize_ret = 60;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_update_unresolved_kv_count = 61;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_acknowledge_key_executed = 62;
    constexpr EventSymbol gnn_vanilla_kvmsr__receiver_check_materialized_count = 63;
    constexpr EventSymbol gnn_vanilla_kvmsr__mapper_control_init = 64;
    constexpr EventSymbol gnn_vanilla_kvmsr__mapper_control_read_partition = 65;
    constexpr EventSymbol gnn_vanilla_kvmsr__mapper_control_get_next_return = 66;
    constexpr EventSymbol gnn_vanilla_kvmsr__mapper_control_loop = 67;
    constexpr EventSymbol gnn_vanilla_kvmsr__lane_remote_mapper_finished = 68;
    constexpr EventSymbol gnn_vanilla_master__gnn_start = 69;
    constexpr EventSymbol gnn_vanilla_master__gnn_term = 70;
    constexpr EventSymbol gnn_vanilla_kvmsr__kv_map = 71;
    constexpr EventSymbol gnn_vanilla_kvmsr__kv_reduce = 72;
    constexpr EventSymbol gnn_vanilla_kvmsr__kv_reduce_compute = 73;
    constexpr EventSymbol gnn_vanilla_kvmsr__kv_reduce_write_back = 74;
    constexpr EventSymbol Broadcast__broadcast_global = 75;
    constexpr EventSymbol Broadcast__broadcast_node = 76;
    constexpr EventSymbol Broadcast__broadcast_ud = 77;
    constexpr EventSymbol Broadcast__broadcast_ud_fin = 78;
    constexpr EventSymbol Broadcast__broadcast_node_fin = 79;
    constexpr EventSymbol Broadcast__broadcast_global_fin = 80;
    constexpr EventSymbol Broadcast__broadcast_value_to_scratchpad = 81;
