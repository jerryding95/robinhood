...
UpDown::UDRuntime_t* gen_runtime(uint64_t num_workers){
  ...
  UpDown::UDRuntime_t *rt = 
    ...
    printf("Running Gem5\n");
#elif defined (BASIM)
    new UpDown::BASimUDRuntime_t(machine, "spmv_lbmsr_exe.bin", 0);
...
int main(int argc, char* argv[]) {
  ...
  UpDown::UDRuntime_t* rt = gen_runtime(num_workers);

  return test_exec(rt, path, num_workers);
