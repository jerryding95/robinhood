...
def efaProgram_phase1_kvmsr_module(efa):
    ...
    Broadcast__broadcast_global.writeAction("bgt X25 X16 GenLinkableBroadcast_kbeam_max_child_modular_eq_zero")
    Broadcast__broadcast_global.writeAction("andi X27 X16 2047")
    Broadcast__broadcast_global.writeAction("beqi X16 0 GenLinkableBroadcast_kbeam_modular_eq_zero")
    Broadcast__broadcast_global.writeAction("addi X25 X25 1")
    Broadcast__broadcast_global.writeAction("jmp GenLinkableBroadcast_kbeam_modular_eq_zero")
    Broadcast__broadcast_global.writeAction("GenLinkableBroadcast_kbeam_max_child_modular_eq_zero: mov_imm2reg X25 512")
    Broadcast__broadcast_global.writeAction("GenLinkableBroadcast_kbeam_modular_eq_zero: evi X2 X28 255 4")
    ...
    Broadcast__broadcast_global.writeAction("GenLinkableBroadcast_kbeam_broadcast_loop: lshift X17 X16 11")
    ...
    Broadcast__broadcast_global.writeAction("blt X17 X25 GenLinkableBroadcast_kbeam_broadcast_loop")
    ...
    Broadcast__broadcast_node.writeAction("bgt X25 X16 GenLinkableBroadcast_kbeam_max_child_modular_eq_zero")
    Broadcast__broadcast_node.writeAction("andi X8 X16 63")
    Broadcast__broadcast_node.writeAction("beqi X16 0 GenLinkableBroadcast_kbeam_modular_eq_zero")
    Broadcast__broadcast_node.writeAction("addi X25 X25 1")
    Broadcast__broadcast_node.writeAction("jmp GenLinkableBroadcast_kbeam_modular_eq_zero")
    Broadcast__broadcast_node.writeAction("GenLinkableBroadcast_kbeam_max_child_modular_eq_zero: mov_imm2reg X25 32")
    Broadcast__broadcast_node.writeAction("GenLinkableBroadcast_kbeam_modular_eq_zero: evi X2 X28 255 4")
    ...
    Broadcast__broadcast_node.writeAction("GenLinkableBroadcast_kbeam_broadcast_loop: lshift X17 X16 6")
    ...
    Broadcast__broadcast_node.writeAction("blt X17 X25 GenLinkableBroadcast_kbeam_broadcast_loop")
    ...
    Broadcast__broadcast_ud.writeAction("bgt X8 X25 GenLinkableBroadcast_kbeam_modular_eq_zero")
    Broadcast__broadcast_ud.writeAction("addi X8 X25 0")
    Broadcast__broadcast_ud.writeAction("GenLinkableBroadcast_kbeam_modular_eq_zero: evi X2 X28 255 4")
    Broadcast__broadcast_ud.writeAction("ev X28 X28 X9 X9 1")
    Broadcast__broadcast_ud.writeAction("mov_imm2reg X17 0")
    Broadcast__broadcast_ud.writeAction("GenLinkableBroadcast_kbeam_broadcast_loop: add X0 X17 X16")
    ...
    Broadcast__broadcast_ud.writeAction("blt X17 X25 GenLinkableBroadcast_kbeam_broadcast_loop")
    ...
    Broadcast__broadcast_ud_fin.writeAction("blt X26 X25 GenLinkableBroadcast_kbeam_continue")
    Broadcast__broadcast_ud_fin.writeAction("sendr_reply X0 X2 X16")
    Broadcast__broadcast_ud_fin.writeAction("yield_terminate")
    Broadcast__broadcast_ud_fin.writeAction("GenLinkableBroadcast_kbeam_continue: yield")
    ...
    Broadcast__broadcast_node_fin.writeAction("blt X26 X25 GenLinkableBroadcast_kbeam_continue")
    Broadcast__broadcast_node_fin.writeAction("sendr_reply X0 X2 X16")
    Broadcast__broadcast_node_fin.writeAction("yield_terminate")
    Broadcast__broadcast_node_fin.writeAction("GenLinkableBroadcast_kbeam_continue: yield")
    ...
    Broadcast__broadcast_global_fin.writeAction("beq X26 X25 GenLinkableBroadcast_kbeam_global_bcst_finish")
    Broadcast__broadcast_global_fin.writeAction("yield")
    Broadcast__broadcast_global_fin.writeAction("GenLinkableBroadcast_kbeam_global_bcst_finish: sendr_reply X0 X2 X16")
    ...
    linkable_lm_cache__broadcast_global.writeAction("bgt X25 X16 GenLinkableLMCache_lfofb_max_child_modular_eq_zero")
    linkable_lm_cache__broadcast_global.writeAction("andi X27 X16 2047")
    linkable_lm_cache__broadcast_global.writeAction("beqi X16 0 GenLinkableLMCache_lfofb_modular_eq_zero")
    linkable_lm_cache__broadcast_global.writeAction("addi X25 X25 1")
    linkable_lm_cache__broadcast_global.writeAction("jmp GenLinkableLMCache_lfofb_modular_eq_zero")
    linkable_lm_cache__broadcast_global.writeAction("GenLinkableLMCache_lfofb_max_child_modular_eq_zero: mov_imm2reg X25 512")
    linkable_lm_cache__broadcast_global.writeAction("GenLinkableLMCache_lfofb_modular_eq_zero: evi X2 X28 255 4")
    ...
    linkable_lm_cache__broadcast_global.writeAction("GenLinkableLMCache_lfofb_broadcast_loop: lshift X17 X16 11")
    ...
    linkable_lm_cache__broadcast_global.writeAction("blt X17 X25 GenLinkableLMCache_lfofb_broadcast_loop")
    ...
    linkable_lm_cache__broadcast_node.writeAction("bgt X25 X16 GenLinkableLMCache_lfofb_max_child_modular_eq_zero")
    linkable_lm_cache__broadcast_node.writeAction("andi X8 X16 63")
    linkable_lm_cache__broadcast_node.writeAction("beqi X16 0 GenLinkableLMCache_lfofb_modular_eq_zero")
    linkable_lm_cache__broadcast_node.writeAction("addi X25 X25 1")
    linkable_lm_cache__broadcast_node.writeAction("jmp GenLinkableLMCache_lfofb_modular_eq_zero")
    linkable_lm_cache__broadcast_node.writeAction("GenLinkableLMCache_lfofb_max_child_modular_eq_zero: mov_imm2reg X25 32")
    linkable_lm_cache__broadcast_node.writeAction("GenLinkableLMCache_lfofb_modular_eq_zero: evi X2 X28 255 4")
    ...
    linkable_lm_cache__broadcast_node.writeAction("GenLinkableLMCache_lfofb_broadcast_loop: lshift X17 X16 6")
    ...
    linkable_lm_cache__broadcast_node.writeAction("blt X17 X25 GenLinkableLMCache_lfofb_broadcast_loop")
    ...
    linkable_lm_cache__broadcast_ud.writeAction("bgt X8 X25 GenLinkableLMCache_lfofb_modular_eq_zero")
    linkable_lm_cache__broadcast_ud.writeAction("addi X8 X25 0")
    linkable_lm_cache__broadcast_ud.writeAction("GenLinkableLMCache_lfofb_modular_eq_zero: evi X2 X28 255 4")
    ...
    linkable_lm_cache__broadcast_ud.writeAction("GenLinkableLMCache_lfofb_broadcast_loop: add X0 X17 X16")
    ...
    linkable_lm_cache__broadcast_ud.writeAction("blt X17 X25 GenLinkableLMCache_lfofb_broadcast_loop")
    ...
    linkable_lm_cache__broadcast_ud_fin.writeAction("blt X26 X25 GenLinkableLMCache_lfofb_continue")
    ...
    linkable_lm_cache__broadcast_ud_fin.writeAction("GenLinkableLMCache_lfofb_continue: yield")
    ...
    linkable_lm_cache__broadcast_node_fin.writeAction("blt X26 X25 GenLinkableLMCache_lfofb_continue")
    ...
    linkable_lm_cache__broadcast_node_fin.writeAction("GenLinkableLMCache_lfofb_continue: yield")
    ...
    linkable_lm_cache__broadcast_global_fin.writeAction("beq X26 X25 GenLinkableLMCache_lfofb_global_bcst_finish")
    linkable_lm_cache__broadcast_global_fin.writeAction("yield")
    linkable_lm_cache__broadcast_global_fin.writeAction("GenLinkableLMCache_lfofb_global_bcst_finish: sendr_reply X0 X2 X16")
    ...
    linkable_lm_cache____cache_init_lane.writeAction("GenLinkableLMCache_lfofb_init_cache_loop: movwrl X16 X17(X18,1,1)")
    linkable_lm_cache____cache_init_lane.writeAction("blt X18 X19 GenLinkableLMCache_lfofb_init_cache_loop")
    ...
    linkable_lm_cache____cache_get.writeAction("beqi X23 0 GenLinkableLMCache_lfofb_cache_active_miss")
    ...
    linkable_lm_cache____cache_get.writeAction("beq X19 X17 GenLinkableLMCache_lfofb_cache_get_hit")
    linkable_lm_cache____cache_get.writeAction("jmp GenLinkableLMCache_lfofb_cache_get_miss")
    linkable_lm_cache____cache_get.writeAction("GenLinkableLMCache_lfofb_cache_active_miss: evi X2 X31 255 4")
    ...
    linkable_lm_cache____cache_get.writeAction("GenLinkableLMCache_lfofb_cache_get_hit: move X8 0(X16) 0 8")
    ...
    linkable_lm_cache____cache_get.writeAction("yieldt")
    linkable_lm_cache____cache_get.writeAction("GenLinkableLMCache_lfofb_cache_get_miss: print '[DEBUG][NWID %ld][linkable_lm_cache::__cache_get] Cache miss. Get values for key = %ld' X0 X8")
    ...
    linkable_lm_cache____cache_get_return.writeAction("beqi X17 -1 GenLinkableLMCache_lfofb_skip_flush")
    linkable_lm_cache____cache_get_return.writeAction("sri X17 X23 63")
    linkable_lm_cache____cache_get_return.writeAction("beqi X23 0 GenLinkableLMCache_lfofb_cache_occupied")
    ...
    linkable_lm_cache____cache_get_return.writeAction("GenLinkableLMCache_lfofb_skip_flush: movrl X21 0(X16) 0 8")
    linkable_lm_cache____cache_get_return.writeAction("movrl X8 8(X16) 0 8")
    linkable_lm_cache____cache_get_return.writeAction("print '[DEBUG][NWID %ld][linkable_lm_cache::__cache_get_return] Cache key = %lu loaded values = [%ld, %ld, ] at addr = 0x%lx' X0 X21 X8 X9 X16")
    ...
    linkable_lm_cache____cache_get_return.writeAction("GenLinkableLMCache_lfofb_cache_occupied: addi X7 X18 1792")
    ...
    linkable_lm_cache____cache_get_return.writeAction("yieldt")
    linkable_lm_cache____cache_get_return.writeAction("GenLinkableLMCache_lfofb_get_fail: movir X23 -1")
    linkable_lm_cache____cache_get_return.writeAction("movir X31 -1")
    linkable_lm_cache____cache_get_return.writeAction("sri X31 X31 1")
    ...
    linkable_lm_cache____cache_get_flush_ack.writeAction("bgti X19 0 GenLinkableLMCache_lfofb_continue")
    ...
    linkable_lm_cache____cache_get_flush_ack.writeAction("GenLinkableLMCache_lfofb_continue: yieldt")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("beqi X24 0 GenLinkableLMCache_lfofb_cache_occupied")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("beq X25 X17 GenLinkableLMCache_lfofb_cache_hit")
    linkable_lm_cache____cache_combine_value.writeAction("jmp GenLinkableLMCache_lfofb_cache_evict")
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_cache_occupied: evi X2 X21 255 4")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_cache_hit: move 8(X16) X23 0 8")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("bge X9 X23 GenLinkableLMCache_lfofb_combine_fail")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("yieldt")
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_cache_evict: movrl X8 0(X16) 0 8")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("beqi X17 -1 GenLinkableLMCache_lfofb_skip_flush")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("jmp GenLinkableLMCache_lfofb_contiue")
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_skip_flush: print '[DEBUG][NWID %ld][linkable_lm_cache::__cache_combine_value] Invalid cached_key = %ld(0x%lx) skip put pair' X0 X17 X17")
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_contiue: addi X2 X21 0")
    ...
    linkable_lm_cache____cache_combine_value.writeAction("GenLinkableLMCache_lfofb_combine_fail: movir X24 -1")
    ...
    linkable_lm_cache____combine_value_get_return.writeAction("bge X23 X8 GenLinkableLMCache_lfofb_combine_fail")
    ...
    linkable_lm_cache____combine_value_get_return.writeAction("GenLinkableLMCache_lfofb_get_fail: subi X19 X19 1")
    linkable_lm_cache____combine_value_get_return.writeAction("beqi X19 0 GenLinkableLMCache_lfofb_finish_write_back")
    linkable_lm_cache____combine_value_get_return.writeAction("yield")
    linkable_lm_cache____combine_value_get_return.writeAction("GenLinkableLMCache_lfofb_finish_write_back: movir X22 1")
    ...
    linkable_lm_cache____combine_value_get_return.writeAction("GenLinkableLMCache_lfofb_combine_fail: movir X24 -1")
    ...
    linkable_lm_cache____combine_value_put_pair_ack.writeAction("beqi X19 0 GenLinkableLMCache_lfofb_finish_write_back")
    linkable_lm_cache____combine_value_put_pair_ack.writeAction("yield")
    linkable_lm_cache____combine_value_put_pair_ack.writeAction("GenLinkableLMCache_lfofb_finish_write_back: movir X22 1")
    ...
    linkable_lm_cache____cache_flush_lane.writeAction("GenLinkableLMCache_lfofb_flush_loop: bge X20 X16 GenLinkableLMCache_lfofb_break_flush_loop")
    linkable_lm_cache____cache_flush_lane.writeAction("movlr 0(X20) X21 0 8")
    linkable_lm_cache____cache_flush_lane.writeAction("beq X21 X22 GenLinkableLMCache_lfofb_continue_flush_loop")
    ...
    linkable_lm_cache____cache_flush_lane.writeAction("jmp GenLinkableLMCache_lfofb_flush_loop")
    linkable_lm_cache____cache_flush_lane.writeAction("GenLinkableLMCache_lfofb_continue_flush_loop: addi X20 X20 16")
    ...
    linkable_lm_cache____cache_flush_lane.writeAction("jmp GenLinkableLMCache_lfofb_flush_loop")
    linkable_lm_cache____cache_flush_lane.writeAction("GenLinkableLMCache_lfofb_break_flush_loop: beqi X19 0 GenLinkableLMCache_lfofb_empty_cache")
    linkable_lm_cache____cache_flush_lane.writeAction("yield")
    linkable_lm_cache____cache_flush_lane.writeAction("GenLinkableLMCache_lfofb_empty_cache: movir X21 -1")
    linkable_lm_cache____cache_flush_lane.writeAction("sri X21 X21 1")
    ...
    linkable_lm_cache____cache_flush_lane_ack.writeAction("bnei X19 0 GenLinkableLMCache_lfofb_continue_flush_loop")
    ...
    linkable_lm_cache____cache_flush_lane_ack.writeAction("GenLinkableLMCache_lfofb_continue_flush_loop: yield")
    ...
    DistributedSortPhase1__finish_init_udkvmsr.writeAction("bgei X26 3 GenKMerCntMSREFA_vbhnq_finish_initialize_udkvmsr")
    DistributedSortPhase1__finish_init_udkvmsr.writeAction("yield")
    DistributedSortPhase1__finish_init_udkvmsr.writeAction("GenKMerCntMSREFA_vbhnq_finish_initialize_udkvmsr: addi X2 X30 0")
    ...
    Dsort_input__generate_partition_array.writeAction("beq X30 X20 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    Dsort_input__generate_partition_array.writeAction("addi X22 X22 1")
    Dsort_input__generate_partition_array.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: sli X22 X23 3")
    ...
    Dsort_input__generate_partition_array.writeAction("GenKMerCntMSREFA_vbhnq_write_partition_array_loop: bge X18 X24 GenKMerCntMSREFA_vbhnq_loop_break")
    Dsort_input__generate_partition_array.writeAction("add X19 X23 X25")
    Dsort_input__generate_partition_array.writeAction("ble X25 X17 GenKMerCntMSREFA_vbhnq_continue")
    Dsort_input__generate_partition_array.writeAction("addi X17 X25 0")
    Dsort_input__generate_partition_array.writeAction("GenKMerCntMSREFA_vbhnq_continue: sendr2_dmlm X18 X27 X19 X25")
    ...
    Dsort_input__generate_partition_array.writeAction("jmp GenKMerCntMSREFA_vbhnq_write_partition_array_loop")
    Dsort_input__generate_partition_array.writeAction("GenKMerCntMSREFA_vbhnq_loop_break: movir X26 0")
    ...
    Dsort_input__write_partition_array_return.writeAction("blt X26 X21 GenKMerCntMSREFA_vbhnq_continue")
    ...
    Dsort_input__write_partition_array_return.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    DistributedSortPhase1__broadcast_global.writeAction("bgt X25 X16 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    DistributedSortPhase1__broadcast_global.writeAction("andi X27 X16 2047")
    DistributedSortPhase1__broadcast_global.writeAction("beqi X16 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__broadcast_global.writeAction("addi X25 X25 1")
    DistributedSortPhase1__broadcast_global.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 512")
    DistributedSortPhase1__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    DistributedSortPhase1__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X17 X16 11")
    ...
    DistributedSortPhase1__broadcast_global.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__broadcast_node.writeAction("bgt X25 X16 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    DistributedSortPhase1__broadcast_node.writeAction("andi X8 X16 63")
    DistributedSortPhase1__broadcast_node.writeAction("beqi X16 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__broadcast_node.writeAction("addi X25 X25 1")
    DistributedSortPhase1__broadcast_node.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 32")
    DistributedSortPhase1__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    DistributedSortPhase1__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X17 X16 6")
    ...
    DistributedSortPhase1__broadcast_node.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__broadcast_ud.writeAction("bgt X8 X25 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__broadcast_ud.writeAction("addi X8 X25 0")
    DistributedSortPhase1__broadcast_ud.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    DistributedSortPhase1__broadcast_ud.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: add X0 X17 X16")
    ...
    DistributedSortPhase1__broadcast_ud.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__broadcast_ud_fin.writeAction("blt X26 X25 GenKMerCntMSREFA_vbhnq_continue")
    ...
    DistributedSortPhase1__broadcast_ud_fin.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    DistributedSortPhase1__broadcast_node_fin.writeAction("blt X26 X25 GenKMerCntMSREFA_vbhnq_continue")
    ...
    DistributedSortPhase1__broadcast_node_fin.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    DistributedSortPhase1__broadcast_global_fin.writeAction("beq X26 X25 GenKMerCntMSREFA_vbhnq_global_bcst_finish")
    DistributedSortPhase1__broadcast_global_fin.writeAction("yield")
    DistributedSortPhase1__broadcast_global_fin.writeAction("GenKMerCntMSREFA_vbhnq_global_bcst_finish: sendr_reply X0 X2 X16")
    ...
    DistributedSortPhase1__init_global_master.writeAction("bgt X25 X28 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    DistributedSortPhase1__init_global_master.writeAction("andi X27 X28 2047")
    DistributedSortPhase1__init_global_master.writeAction("beqi X28 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__init_global_master.writeAction("addi X25 X25 1")
    DistributedSortPhase1__init_global_master.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__init_global_master.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 512")
    DistributedSortPhase1__init_global_master.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: mov_imm2reg X22 2048")
    DistributedSortPhase1__init_global_master.writeAction("bge X27 X22 GenKMerCntMSREFA_vbhnq_global_master_full_child")
    DistributedSortPhase1__init_global_master.writeAction("addi X27 X22 0")
    DistributedSortPhase1__init_global_master.writeAction("GenKMerCntMSREFA_vbhnq_global_master_full_child: mul X22 X9 X20")
    ...
    DistributedSortPhase1__init_global_master.writeAction("GenKMerCntMSREFA_vbhnq_glb_master_loop: ev_update_reg_2             X30 X30 X23 X23 8")
    ...
    DistributedSortPhase1__init_global_master.writeAction("blt X21 X25 GenKMerCntMSREFA_vbhnq_glb_master_loop")
    ...
    DistributedSortPhase1__global_master.writeAction("bge X17 X24 GenKMerCntMSREFA_vbhnq_global_master_fin_fetch")
    ...
    DistributedSortPhase1__global_master.writeAction("GenKMerCntMSREFA_vbhnq_global_master_fin_fetch: subi X21 X21 1")
    ...
    DistributedSortPhase1__global_master.writeAction("beqi X21 0 GenKMerCntMSREFA_vbhnq_global_master_fin_map")
    DistributedSortPhase1__global_master.writeAction("yield")
    DistributedSortPhase1__global_master.writeAction("GenKMerCntMSREFA_vbhnq_global_master_fin_map: bnei X19 0 GenKMerCntMSREFA_vbhnq_global_master_init_sync")
    ...
    DistributedSortPhase1__global_master.writeAction("GenKMerCntMSREFA_vbhnq_global_master_init_sync: evi X2 X30 255 4")
    ...
    DistributedSortPhase1__init_node_master.writeAction("bgt X25 X28 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    DistributedSortPhase1__init_node_master.writeAction("andi X27 X28 63")
    DistributedSortPhase1__init_node_master.writeAction("beqi X28 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__init_node_master.writeAction("addi X25 X25 1")
    DistributedSortPhase1__init_node_master.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__init_node_master.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 32")
    DistributedSortPhase1__init_node_master.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: add X9 X16 X24")
    ...
    DistributedSortPhase1__init_node_master.writeAction("bge X27 X22 GenKMerCntMSREFA_vbhnq_node_master_full_child")
    DistributedSortPhase1__init_node_master.writeAction("addi X27 X22 0")
    DistributedSortPhase1__init_node_master.writeAction("GenKMerCntMSREFA_vbhnq_node_master_full_child: div X9 X25 X18")
    ...
    DistributedSortPhase1__init_node_master.writeAction("GenKMerCntMSREFA_vbhnq_node_master_loop: ev X30 X30 X23 X23 8")
    ...
    DistributedSortPhase1__init_node_master.writeAction("blt X21 X25 GenKMerCntMSREFA_vbhnq_node_master_loop")
    ...
    DistributedSortPhase1__node_master.writeAction("bge X16 X24 GenKMerCntMSREFA_vbhnq_node_master_fin_fetch")
    ...
    DistributedSortPhase1__node_master.writeAction("GenKMerCntMSREFA_vbhnq_node_master_fin_fetch: subi X21 X21 1")
    ...
    DistributedSortPhase1__node_master.writeAction("beqi X21 0 GenKMerCntMSREFA_vbhnq_node_master_fin_partition")
    DistributedSortPhase1__node_master.writeAction("yield")
    DistributedSortPhase1__node_master.writeAction("GenKMerCntMSREFA_vbhnq_node_master_fin_partition: sendr_wret X31 DistributedSortPhase1__init_node_master             X19 X19 X28")
    ...
    DistributedSortPhase1__init_updown_master.writeAction("bgt X27 X25 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    DistributedSortPhase1__init_updown_master.writeAction("addi X27 X25 0")
    DistributedSortPhase1__init_updown_master.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: add X9 X16 X24")
    ...
    DistributedSortPhase1__init_updown_master.writeAction("GenKMerCntMSREFA_vbhnq_updown_master_loop: ev X30 X30 X23 X23 8")
    ...
    DistributedSortPhase1__init_updown_master.writeAction("blt X21 X25 GenKMerCntMSREFA_vbhnq_updown_master_loop")
    ...
    DistributedSortPhase1__updown_master.writeAction("bge X16 X24 GenKMerCntMSREFA_vbhnq_updown_master_fin_fetch")
    ...
    DistributedSortPhase1__updown_master.writeAction("GenKMerCntMSREFA_vbhnq_updown_master_fin_fetch: subi X21 X21 1")
    ...
    DistributedSortPhase1__updown_master.writeAction("blei X21 0 GenKMerCntMSREFA_vbhnq_updown_master_fin_partition")
    DistributedSortPhase1__updown_master.writeAction("yield")
    DistributedSortPhase1__updown_master.writeAction("GenKMerCntMSREFA_vbhnq_updown_master_fin_partition: sendr_wret X31             DistributedSortPhase1__init_updown_master X19 X19 X28")
    ...
    DistributedSortPhase1__lane_master_loop.writeAction("beqi X23 1 GenKMerCntMSREFA_vbhnq_lane_master_loop_continue")
    DistributedSortPhase1__lane_master_loop.writeAction("bge X23 X24 GenKMerCntMSREFA_vbhnq_lane_master_reach_end")
    ...
    DistributedSortPhase1__lane_master_loop.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_reach_end: bgti X16 0 GenKMerCntMSREFA_vbhnq_lane_master_loop_continue")
    ...
    DistributedSortPhase1__lane_master_loop.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_loop_continue: yield")
    ...
    DistributedSortPhase1__lane_master_read_partition.writeAction("bge X8 X9 GenKMerCntMSREFA_vbhnq_lane_master_empty_partition")
    ...
    DistributedSortPhase1__lane_master_read_partition.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_empty_partition: sendr_wret X31 DistributedSortPhase1__lane_master_init X19 X19 X28")
    DistributedSortPhase1__lane_master_read_partition.writeAction("yield")
    ...
    DistributedSortPhase1__lane_master_get_next_return.writeAction("bge X16 X17 GenKMerCntMSREFA_vbhnq_lane_master_break_iterate_loop")
    DistributedSortPhase1__lane_master_get_next_return.writeAction("bge X8 X9 GenKMerCntMSREFA_vbhnq_lane_master_break_iterate_loop")
    ...
    DistributedSortPhase1__lane_master_get_next_return.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_break_iterate_loop: movir X23 0")
    ...
    DistributedSortPhase1__lane_master_get_next_return.writeAction("yield")
    DistributedSortPhase1__lane_master_get_next_return.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_iterator_pass_end: subi X16 X16 1")
    DistributedSortPhase1__lane_master_get_next_return.writeAction("addi X8 X23 0")
    DistributedSortPhase1__lane_master_get_next_return.writeAction("addi X9 X24 0")
    DistributedSortPhase1__lane_master_get_next_return.writeAction("bgti X16 0 GenKMerCntMSREFA_vbhnq_lane_master_loop_continue")
    ...
    DistributedSortPhase1__lane_master_get_next_return.writeAction("GenKMerCntMSREFA_vbhnq_lane_master_loop_continue: yield")
    ...
    DistributedSortPhase1__init_global_snyc.writeAction("bgt X16 X28 GenKMerCntMSREFA_vbhnq_max_child_max_node")
    DistributedSortPhase1__init_global_snyc.writeAction("andi X8 X28 2047")
    DistributedSortPhase1__init_global_snyc.writeAction("beqi X28 0 GenKMerCntMSREFA_vbhnq_max_node")
    DistributedSortPhase1__init_global_snyc.writeAction("addi X16 X16 1")
    DistributedSortPhase1__init_global_snyc.writeAction("jmp GenKMerCntMSREFA_vbhnq_max_node")
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_max_child_max_node: mov_imm2reg X16 512")
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_max_node: addi X16 X16 0")
    ...
    DistributedSortPhase1__init_global_snyc.writeAction("bgt X17 X28 GenKMerCntMSREFA_vbhnq_max_child_max_ud_per_nd")
    DistributedSortPhase1__init_global_snyc.writeAction("andi X8 X28 63")
    DistributedSortPhase1__init_global_snyc.writeAction("beqi X28 0 GenKMerCntMSREFA_vbhnq_max_ud_per_nd")
    DistributedSortPhase1__init_global_snyc.writeAction("addi X17 X17 1")
    DistributedSortPhase1__init_global_snyc.writeAction("jmp GenKMerCntMSREFA_vbhnq_max_ud_per_nd")
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_max_child_max_ud_per_nd: mov_imm2reg X17 32")
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_max_ud_per_nd: addi X17 X17 0")
    DistributedSortPhase1__init_global_snyc.writeAction("movir X18 64")
    DistributedSortPhase1__init_global_snyc.writeAction("bgt X8 X18 GenKMerCntMSREFA_vbhnq_max_ln_per_ud")
    DistributedSortPhase1__init_global_snyc.writeAction("addi X8 X18 0")
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_max_ln_per_ud: addi X18 X18 0")
    ...
    DistributedSortPhase1__init_global_snyc.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X29 X28 11")
    ...
    DistributedSortPhase1__init_global_snyc.writeAction("blt X29 X16 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__init_node_sync.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X29 X28 6")
    ...
    DistributedSortPhase1__init_node_sync.writeAction("blt X29 X17 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__ud_accumulate.writeAction("GenKMerCntMSREFA_vbhnq_accumulate_loop: lshift X20 X17 16")
    ...
    DistributedSortPhase1__ud_accumulate.writeAction("blt X20 X8 GenKMerCntMSREFA_vbhnq_accumulate_loop")
    ...
    DistributedSortPhase1__global_sync_return.writeAction("blt X20 X16 GenKMerCntMSREFA_vbhnq_continue")
    DistributedSortPhase1__global_sync_return.writeAction("bge X22 X21 GenKMerCntMSREFA_vbhnq_sync_finish")
    DistributedSortPhase1__global_sync_return.writeAction("mov_imm2reg X29 0")
    DistributedSortPhase1__global_sync_return.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X29 X28 11")
    ...
    DistributedSortPhase1__global_sync_return.writeAction("blt X29 X16 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    DistributedSortPhase1__global_sync_return.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    DistributedSortPhase1__global_sync_return.writeAction("GenKMerCntMSREFA_vbhnq_sync_finish: movir X30 -1")
    ...
    DistributedSortPhase1__node_sync_return.writeAction("blt X20 X17 GenKMerCntMSREFA_vbhnq_continue")
    ...
    DistributedSortPhase1__node_sync_return.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    DistributedSortPhase1__init_reduce_thread.writeAction("bge X28 X29 GenKMerCntMSREFA_vbhnq_push_back_to_queue")
    ...
    DistributedSortPhase1__init_reduce_thread.writeAction("GenKMerCntMSREFA_vbhnq_push_back_to_queue: ev_update_1 EQT X30 255 4")
    ...
    phase1_bin_size_cache__broadcast_global.writeAction("bgt X25 X16 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    phase1_bin_size_cache__broadcast_global.writeAction("andi X27 X16 2047")
    phase1_bin_size_cache__broadcast_global.writeAction("beqi X16 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    phase1_bin_size_cache__broadcast_global.writeAction("addi X25 X25 1")
    phase1_bin_size_cache__broadcast_global.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    phase1_bin_size_cache__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 512")
    phase1_bin_size_cache__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    phase1_bin_size_cache__broadcast_global.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X17 X16 11")
    ...
    phase1_bin_size_cache__broadcast_global.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    phase1_bin_size_cache__broadcast_node.writeAction("bgt X25 X16 GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero")
    phase1_bin_size_cache__broadcast_node.writeAction("andi X8 X16 63")
    phase1_bin_size_cache__broadcast_node.writeAction("beqi X16 0 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    phase1_bin_size_cache__broadcast_node.writeAction("addi X25 X25 1")
    phase1_bin_size_cache__broadcast_node.writeAction("jmp GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    phase1_bin_size_cache__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_max_child_modular_eq_zero: mov_imm2reg X25 32")
    phase1_bin_size_cache__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    phase1_bin_size_cache__broadcast_node.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: lshift X17 X16 6")
    ...
    phase1_bin_size_cache__broadcast_node.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    phase1_bin_size_cache__broadcast_ud.writeAction("bgt X8 X25 GenKMerCntMSREFA_vbhnq_modular_eq_zero")
    phase1_bin_size_cache__broadcast_ud.writeAction("addi X8 X25 0")
    phase1_bin_size_cache__broadcast_ud.writeAction("GenKMerCntMSREFA_vbhnq_modular_eq_zero: evi X2 X28 255 4")
    ...
    phase1_bin_size_cache__broadcast_ud.writeAction("GenKMerCntMSREFA_vbhnq_broadcast_loop: add X0 X17 X16")
    ...
    phase1_bin_size_cache__broadcast_ud.writeAction("blt X17 X25 GenKMerCntMSREFA_vbhnq_broadcast_loop")
    ...
    phase1_bin_size_cache__broadcast_ud_fin.writeAction("blt X26 X25 GenKMerCntMSREFA_vbhnq_continue")
    ...
    phase1_bin_size_cache__broadcast_ud_fin.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    phase1_bin_size_cache__broadcast_node_fin.writeAction("blt X26 X25 GenKMerCntMSREFA_vbhnq_continue")
    ...
    phase1_bin_size_cache__broadcast_node_fin.writeAction("GenKMerCntMSREFA_vbhnq_continue: yield")
    ...
    phase1_bin_size_cache__broadcast_global_fin.writeAction("beq X26 X25 GenKMerCntMSREFA_vbhnq_global_bcst_finish")
    phase1_bin_size_cache__broadcast_global_fin.writeAction("yield")
    phase1_bin_size_cache__broadcast_global_fin.writeAction("GenKMerCntMSREFA_vbhnq_global_bcst_finish: sendr_reply X0 X2 X16")
    ...
    phase1_bin_size_cache____cache_init_lane.writeAction("GenKMerCntMSREFA_vbhnq_init_cache_loop: movwrl X16 X17(X18,1,1)")
    phase1_bin_size_cache____cache_init_lane.writeAction("blt X18 X19 GenKMerCntMSREFA_vbhnq_init_cache_loop")
    ...
    phase1_bin_size_cache____cache_get.writeAction("beqi X23 0 GenKMerCntMSREFA_vbhnq_cache_active_miss")
    ...
    phase1_bin_size_cache____cache_get.writeAction("beq X19 X17 GenKMerCntMSREFA_vbhnq_cache_get_hit")
    phase1_bin_size_cache____cache_get.writeAction("jmp GenKMerCntMSREFA_vbhnq_cache_get_miss")
    phase1_bin_size_cache____cache_get.writeAction("GenKMerCntMSREFA_vbhnq_cache_active_miss: evi X2 X31 255 4")
    ...
    phase1_bin_size_cache____cache_get.writeAction("GenKMerCntMSREFA_vbhnq_cache_get_hit: move X8 0(X16) 0 8")
    ...
    phase1_bin_size_cache____cache_get.writeAction("yieldt")
    phase1_bin_size_cache____cache_get.writeAction("GenKMerCntMSREFA_vbhnq_cache_get_miss: addi X2 X31 0")
    ...
    phase1_bin_size_cache____cache_get_return.writeAction("beqi X17 -1 GenKMerCntMSREFA_vbhnq_skip_flush")
    phase1_bin_size_cache____cache_get_return.writeAction("sri X17 X23 63")
    phase1_bin_size_cache____cache_get_return.writeAction("beqi X23 0 GenKMerCntMSREFA_vbhnq_cache_occupied")
    ...
    phase1_bin_size_cache____cache_get_return.writeAction("GenKMerCntMSREFA_vbhnq_skip_flush: movrl X21 0(X16) 0 8")
    phase1_bin_size_cache____cache_get_return.writeAction("movrl X8 8(X16) 0 8")
    ...
    phase1_bin_size_cache____cache_get_return.writeAction("GenKMerCntMSREFA_vbhnq_cache_occupied: addi X7 X18 1472")
    ...
    phase1_bin_size_cache____cache_get_return.writeAction("yieldt")
    phase1_bin_size_cache____cache_get_return.writeAction("GenKMerCntMSREFA_vbhnq_get_fail: movir X23 -1")
    phase1_bin_size_cache____cache_get_return.writeAction("movir X31 -1")
    phase1_bin_size_cache____cache_get_return.writeAction("sri X31 X31 1")
    ...
    phase1_bin_size_cache____cache_get_flush_ack.writeAction("bgti X19 0 GenKMerCntMSREFA_vbhnq_continue")
    ...
    phase1_bin_size_cache____cache_get_flush_ack.writeAction("GenKMerCntMSREFA_vbhnq_continue: yieldt")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("beqi X24 0 GenKMerCntMSREFA_vbhnq_cache_occupied")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("beq X25 X17 GenKMerCntMSREFA_vbhnq_cache_hit")
    phase1_bin_size_cache____cache_combine_value.writeAction("jmp GenKMerCntMSREFA_vbhnq_cache_evict")
    phase1_bin_size_cache____cache_combine_value.writeAction("GenKMerCntMSREFA_vbhnq_cache_occupied: evi X2 X21 255 4")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("GenKMerCntMSREFA_vbhnq_cache_hit: move 8(X16) X23 0 8")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("yieldt")
    phase1_bin_size_cache____cache_combine_value.writeAction("GenKMerCntMSREFA_vbhnq_cache_evict: movrl X8 0(X16) 0 8")
    phase1_bin_size_cache____cache_combine_value.writeAction("movir X19 0")
    phase1_bin_size_cache____cache_combine_value.writeAction("beqi X17 -1 GenKMerCntMSREFA_vbhnq_skip_flush")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("GenKMerCntMSREFA_vbhnq_skip_flush: addi X2 X21 0")
    ...
    phase1_bin_size_cache____cache_combine_value.writeAction("GenKMerCntMSREFA_vbhnq_combine_fail: movir X24 -1")
    ...
    phase1_bin_size_cache____combine_value_get_return.writeAction("GenKMerCntMSREFA_vbhnq_get_fail: subi X19 X19 1")
    phase1_bin_size_cache____combine_value_get_return.writeAction("beqi X19 0 GenKMerCntMSREFA_vbhnq_finish_write_back")
    phase1_bin_size_cache____combine_value_get_return.writeAction("yield")
    phase1_bin_size_cache____combine_value_get_return.writeAction("GenKMerCntMSREFA_vbhnq_finish_write_back: movir X22 1")
    ...
    phase1_bin_size_cache____combine_value_get_return.writeAction("GenKMerCntMSREFA_vbhnq_combine_fail: movir X24 -1")
    ...
    phase1_bin_size_cache____combine_value_put_pair_ack.writeAction("beqi X19 0 GenKMerCntMSREFA_vbhnq_finish_write_back")
    phase1_bin_size_cache____combine_value_put_pair_ack.writeAction("yield")
    phase1_bin_size_cache____combine_value_put_pair_ack.writeAction("GenKMerCntMSREFA_vbhnq_finish_write_back: movir X22 1")
    ...
    phase1_bin_size_cache____cache_flush_lane.writeAction("GenKMerCntMSREFA_vbhnq_flush_loop: bge X20 X16 GenKMerCntMSREFA_vbhnq_break_flush_loop")
    phase1_bin_size_cache____cache_flush_lane.writeAction("movlr 0(X20) X21 0 8")
    phase1_bin_size_cache____cache_flush_lane.writeAction("beq X21 X22 GenKMerCntMSREFA_vbhnq_continue_flush_loop")
    ...
    phase1_bin_size_cache____cache_flush_lane.writeAction("jmp GenKMerCntMSREFA_vbhnq_flush_loop")
    phase1_bin_size_cache____cache_flush_lane.writeAction("GenKMerCntMSREFA_vbhnq_continue_flush_loop: addi X20 X20 16")
    phase1_bin_size_cache____cache_flush_lane.writeAction("jmp GenKMerCntMSREFA_vbhnq_flush_loop")
    phase1_bin_size_cache____cache_flush_lane.writeAction("GenKMerCntMSREFA_vbhnq_break_flush_loop: beqi X19 0 GenKMerCntMSREFA_vbhnq_empty_cache")
    phase1_bin_size_cache____cache_flush_lane.writeAction("yield")
    phase1_bin_size_cache____cache_flush_lane.writeAction("GenKMerCntMSREFA_vbhnq_empty_cache: movir X21 -1")
    phase1_bin_size_cache____cache_flush_lane.writeAction("sri X21 X21 1")
    ...
    phase1_bin_size_cache____cache_flush_lane_ack.writeAction("bnei X19 0 GenKMerCntMSREFA_vbhnq_continue_flush_loop")
    ...
    phase1_bin_size_cache____cache_flush_lane_ack.writeAction("GenKMerCntMSREFA_vbhnq_continue_flush_loop: yield")
