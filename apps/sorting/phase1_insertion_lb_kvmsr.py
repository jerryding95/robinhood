...
'''
TASK_NAME       = "DistributedSortPhase1InsertionLb"
...
INPUT_KVSET = OneDimKeyValueSet("Dsort_phase1_insertion_lb_input", element_size=1, metadata_size=4)
# INTERMEDIATE_KVSET = OneDimKeyValueSet("Dsort_intermediate", element_size=2, metadata_size=4)
INTERMEDIATE_KVSET =IntermediateKeyValueSet("Dsort_phase1_insertion_lb_intermediate", key_size=1, value_size=1)
...
def GenKMerCntMSREFA(efa: EFAProgram):
    ...
    testMSR.setup_lb_cache(intermediate_cache_bins_offset = CACHE_LM_OFFSET, intermediate_cache_num_bins = 16, intermediate_cache_size = 64, materialize_kv_cache_size = 64, )
    # else:
