...
'''
TASK_NAME       = "DistributedSortPhase2Mapper"
...
INPUT_KVSET = OneDimKeyValueSet("Dsort_input2_mapper", element_size=1, metadata_size=2)
# INTERMEDIATE_KVSET = OneDimKeyValueSet("Dsort_intermediate", element_size=2, metadata_size=4)
INTERMEDIATE_KVSET =IntermediateKeyValueSet("Dsort_intermediate2_mapper", key_size=1, value_size=2)
