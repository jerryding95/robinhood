...
def EFA_sorting(efa):
  ...
  ## Param "list_addr" uses Register X8, scope (0->30)
  ## Param "list_size" uses Register X9, scope (0->30)
  ## Param "num_lanes" uses Register X10, scope (0->30)
  ## Param "offset_buffer_in" uses Register X11, scope (0->30)
  ## Param "offset_vec_in" uses Register X12, scope (0->30)
  ## Scoped Variable "sp_ptr" uses Register X20, scope (0->30)
  ## Scoped Variable "vec_ptr" uses Register X21, scope (0->30)
  ## Scoped Variable "cur_addr" uses Register X22, scope (0->30)
  ## Scoped Variable "cur_size" uses Register X23, scope (0->30)
  ## Scoped Variable "ev_word" uses Register X24, scope (0->30)
  ## Scoped Variable "evword" uses Register X20, scope (0->33->35)
  ## Scoped Variable "vec_ptr" uses Register X20, scope (0->33->36)
  ## Scoped Variable "nvals" uses Register X21, scope (0->33->36)
  ## Scoped Variable "n_lanes" uses Register X22, scope (0->33->36)
  ## Scoped Variable "evword" uses Register X23, scope (0->33->36)
  ## Scoped Variable "label" uses Register X24, scope (0->33->36)
  ## Scoped Variable "cont_word" uses Register X25, scope (0->33->36)
  ## Scoped Variable "sp_ptr" uses Register X26, scope (0->33->36)
  ## Scoped Variable "evword" uses Register X20, scope (0->41->43)
  ## Scoped Variable "vec_ptr" uses Register X20, scope (0->41->44)
  ## Scoped Variable "n_lanes" uses Register X21, scope (0->41->44)
  ## Scoped Variable "evword" uses Register X22, scope (0->41->44)
  ## Scoped Variable "label" uses Register X23, scope (0->41->44)
  ## Scoped Variable "cont_word" uses Register X24, scope (0->41->44)
  ## Scoped Variable "sp_ptr" uses Register X25, scope (0->41->44)
  ...
  ## Param "src" uses Register X8, scope (0->48)
  ## Param "dst" uses Register X9, scope (0->48)
  ## Param "size_in" uses Register X10, scope (0->48)
  ## Scoped Variable "evw" uses Register X22, scope (0->48)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->49)
  ## Scoped Variable "out_cnt" uses Register X23, scope (0->49)
  ## Scoped Variable "addr" uses Register X24, scope (0->49->51)
  ## Scoped Variable "evw" uses Register X24, scope (0->49->56)
  ## Param "val" uses Register X8, scope (0->57)
  ## Param "addr" uses Register X9, scope (0->57)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->57)
  ## Scoped Variable "lm_ptr" uses Register X23, scope (0->57)
  ## Param "op1" uses Register X8, scope (0->60)
  ## Param "op2" uses Register X9, scope (0->60)
  ## Param "op3" uses Register X10, scope (0->60)
  ## Param "op4" uses Register X11, scope (0->60)
  ## Param "op5" uses Register X12, scope (0->60)
  ## Param "op6" uses Register X13, scope (0->60)
  ## Param "op7" uses Register X14, scope (0->60)
  ## Param "op8" uses Register X15, scope (0->60)
  ## Param "addr" uses Register X3, scope (0->60)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->60)
  ## Scoped Variable "lm_ptr" uses Register X23, scope (0->60)
  ## Param "src" uses Register X8, scope (0->63)
  ## Param "dst" uses Register X9, scope (0->63)
  ## Param "size_in" uses Register X10, scope (0->63)
  ## Scoped Variable "evw" uses Register X22, scope (0->63)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->64)
  ## Scoped Variable "out_cnt" uses Register X23, scope (0->64)
  ## Scoped Variable "addr" uses Register X24, scope (0->64->66)
  ## Scoped Variable "addrto" uses Register X25, scope (0->64->66)
  ## Scoped Variable "evw" uses Register X24, scope (0->64->71)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->72)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->75)
  ## Param "src" uses Register X8, scope (0->78)
  ## Param "dst" uses Register X9, scope (0->78)
  ## Param "size_in" uses Register X10, scope (0->78)
  ## Scoped Variable "evw" uses Register X22, scope (0->78)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->79)
  ## Scoped Variable "out_cnt" uses Register X23, scope (0->79)
  ## Scoped Variable "addr" uses Register X24, scope (0->79->81)
  ## Scoped Variable "evw" uses Register X24, scope (0->79->86)
  ## Param "val" uses Register X8, scope (0->87)
  ## Param "addr" uses Register X9, scope (0->87)
  ## Scoped Variable "to_ptr" uses Register X22, scope (0->87)
  ## Param "op1" uses Register X8, scope (0->88)
  ## Param "op2" uses Register X9, scope (0->88)
  ## Param "op3" uses Register X10, scope (0->88)
  ## Param "op4" uses Register X11, scope (0->88)
  ## Param "op5" uses Register X12, scope (0->88)
  ## Param "op6" uses Register X13, scope (0->88)
  ## Param "op7" uses Register X14, scope (0->88)
  ## Param "op8" uses Register X15, scope (0->88)
  ## Param "addr" uses Register X3, scope (0->88)
  ## Scoped Variable "to_ptr" uses Register X22, scope (0->88)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->89)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->92)
  ## Scoped Variable "cnt" uses Register X16, scope (0)
  ## Scoped Variable "offset" uses Register X17, scope (0)
  ## Param "src" uses Register X8, scope (0->96)
  ## Param "dst" uses Register X9, scope (0->96)
  ## Param "size" uses Register X10, scope (0->96)
  ## Scoped Variable "cur_addr" uses Register X18, scope (0->96)
  ## Param "val" uses Register X8, scope (0->100)
  ## Param "addr" uses Register X9, scope (0->100)
  ## Scoped Variable "lm_ptr" uses Register X18, scope (0->100)
  ## Param "op1" uses Register X8, scope (0->103)
  ## Param "op2" uses Register X9, scope (0->103)
  ## Param "op3" uses Register X10, scope (0->103)
  ## Param "op4" uses Register X11, scope (0->103)
  ## Param "op5" uses Register X12, scope (0->103)
  ## Param "op6" uses Register X13, scope (0->103)
  ## Param "op7" uses Register X14, scope (0->103)
  ## Param "op8" uses Register X15, scope (0->103)
  ## Param "addr" uses Register X3, scope (0->103)
  ## Scoped Variable "lm_ptr" uses Register X18, scope (0->103)
  ## Param "src" uses Register X8, scope (0->106)
  ## Param "dst" uses Register X9, scope (0->106)
  ## Param "size" uses Register X10, scope (0->106)
  ## Scoped Variable "cur_src" uses Register X18, scope (0->106)
  ## Scoped Variable "cur_dst" uses Register X19, scope (0->106)
  ## Param "src" uses Register X8, scope (0->116)
  ## Param "dst" uses Register X9, scope (0->116)
  ## Param "size" uses Register X10, scope (0->116)
  ## Scoped Variable "cur_addr" uses Register X18, scope (0->116)
  ## Param "val" uses Register X8, scope (0->120)
  ## Param "addr" uses Register X9, scope (0->120)
  ## Scoped Variable "to_ptr" uses Register X18, scope (0->120)
  ## Param "op1" uses Register X8, scope (0->121)
  ## Param "op2" uses Register X9, scope (0->121)
  ## Param "op3" uses Register X10, scope (0->121)
  ## Param "op4" uses Register X11, scope (0->121)
  ## Param "op5" uses Register X12, scope (0->121)
  ## Param "op6" uses Register X13, scope (0->121)
  ## Param "op7" uses Register X14, scope (0->121)
  ## Param "op8" uses Register X15, scope (0->121)
  ## Param "addr" uses Register X3, scope (0->121)
  ## Scoped Variable "to_ptr" uses Register X18, scope (0->121)
  ...
  ## Param "list_dram_addr_in" uses Register X8, scope (0->129)
  ## Param "size_in" uses Register X9, scope (0->129)
  ## Param "sp_ptr_in" uses Register X10, scope (0->129)
  ## Param "sp_size_in" uses Register X11, scope (0->129)
  ## Scoped Variable "evw" uses Register X23, scope (0->129)
  ## Scoped Variable "evw" uses Register X23, scope (0->130)
  ## Scoped Variable "l" uses Register X23, scope (0->131->133)
  ## Scoped Variable "r" uses Register X24, scope (0->131->133)
  ## Scoped Variable "ptr" uses Register X25, scope (0->131->133)
  ## Scoped Variable "evw" uses Register X26, scope (0->131->133)
  ## Scoped Variable "evw" uses Register X23, scope (0->131->136)
  ## Scoped Variable "i" uses Register X23, scope (0->137)
  ## Scoped Variable "local_sp_ptr" uses Register X24, scope (0->137)
  ## Scoped Variable "evw" uses Register X25, scope (0->137)
  ## Scoped Variable "evw" uses Register X23, scope (0->141->143)
  ## Scoped Variable "evw" uses Register X23, scope (0->145->147)
  ## Scoped Variable "send_ptr" uses Register X24, scope (0->145->147)
  ## Scoped Variable "last" uses Register X25, scope (0->145->147)
  ## Scoped Variable "evw" uses Register X23, scope (0->145->150)
  ...
  ## Param "p0" uses Register X8, scope (0->152)
  ## Param "p1" uses Register X9, scope (0->152)
  ## Param "p2" uses Register X10, scope (0->152)
  ## Param "sp_ptr_in" uses Register X11, scope (0->152)
  ## Param "sp_size" uses Register X12, scope (0->152)
  ## Param "tmp_addr_in" uses Register X13, scope (0->152)
  ## Scoped Variable "cur_addr" uses Register X27, scope (0->152)
  ## Scoped Variable "lim" uses Register X28, scope (0->152)
  ## Scoped Variable "i" uses Register X28, scope (0->152->153)
  ## Scoped Variable "i" uses Register X29, scope (0->152->158)
  ## Param "val" uses Register X8, scope (0->161)
  ## Param "addr" uses Register X9, scope (0->161)
  ## Scoped Variable "gotcha" uses Register X27, scope (0->161)
  ## Scoped Variable "evw" uses Register X28, scope (0->161->167)
  ## Param "val" uses Register X8, scope (0->170)
  ## Param "addr" uses Register X9, scope (0->170)
  ## Scoped Variable "gotcha" uses Register X27, scope (0->170)
  ## Scoped Variable "evw" uses Register X28, scope (0->170->176)
  ## Scoped Variable "val0" uses Register X27, scope (0->179)
  ## Scoped Variable "val1" uses Register X28, scope (0->179)
  ## Scoped Variable "cur_addr" uses Register X29, scope (0->179->198->200)
  ## Scoped Variable "cur_addr" uses Register X29, scope (0->179->201->203)
  ## Scoped Variable "evw" uses Register X29, scope (0->179->205)
  ## Scoped Variable "evw" uses Register X27, scope (0->206->208)
  ## Scoped Variable "tot_bytes" uses Register X27, scope (0->209)
  ## Scoped Variable "cur_addr" uses Register X28, scope (0->209)
  ## Scoped Variable "evw" uses Register X29, scope (0->209)
  ## Param "val" uses Register X8, scope (0->210)
  ## Param "addr" uses Register X9, scope (0->210)
  ## Scoped Variable "next_addr" uses Register X27, scope (0->210)
  ...
  ## Param "base_lane_in" uses Register X8, scope (0->215)
  ## Param "addr1_in" uses Register X9, scope (0->215)
  ## Param "size1_in" uses Register X10, scope (0->215)
  ## Param "addr2_in" uses Register X11, scope (0->215)
  ## Param "size2_in" uses Register X12, scope (0->215)
  ## Param "offset_buffer_in" uses Register X13, scope (0->215)
  ## Scoped Variable "st" uses Register X25, scope (0->215)
  ## Scoped Variable "ed" uses Register X26, scope (0->215)
  ## Scoped Variable "ptr" uses Register X27, scope (0->215)
  ## Scoped Variable "evw" uses Register X28, scope (0->215)
  ## Scoped Variable "sp_ptr" uses Register X25, scope (0->218->220)
  ## Scoped Variable "i" uses Register X26, scope (0->218->220)
  ## Scoped Variable "ptr" uses Register X27, scope (0->218->220)
  ## Scoped Variable "sum" uses Register X28, scope (0->218->220)
  ## Param "base_lane_in" uses Register X8, scope (0->229)
  ## Param "addr1_in" uses Register X9, scope (0->229)
  ## Param "size1_in" uses Register X10, scope (0->229)
  ## Param "addr2_in" uses Register X11, scope (0->229)
  ## Param "size2_in" uses Register X12, scope (0->229)
  ## Param "offset_buffer_in" uses Register X13, scope (0->229)
  ## Scoped Variable "st" uses Register X25, scope (0->229)
  ## Scoped Variable "ed" uses Register X26, scope (0->229)
  ## Scoped Variable "ptr" uses Register X27, scope (0->229)
  ## Scoped Variable "evw" uses Register X28, scope (0->229)
  ## Param "key" uses Register X8, scope (0->232)
  ## Param "addr" uses Register X9, scope (0->232)
  ## Scoped Variable "sp_ptr" uses Register X25, scope (0->232->236)
  ## Scoped Variable "i" uses Register X26, scope (0->232->236)
  ## Scoped Variable "ptr" uses Register X27, scope (0->232->236)
  ## Scoped Variable "res" uses Register X28, scope (0->232->236)
  ## Scoped Variable "user_cont" uses Register X16, scope (0)
  ## Param "sort_lm_offset" uses Register X8, scope (0->244)
  ## Param "list_size" uses Register X9, scope (0->244)
  ## Param "list_addr" uses Register X10, scope (0->244)
  ## Param "num_lanes" uses Register X11, scope (0->244)
  ## Param "tmp_addr" uses Register X12, scope (0->244)
  ## Param "num_bins" uses Register X13, scope (0->244)
  ## Param "lb_addr" uses Register X14, scope (0->244)
  ## Param "max_value" uses Register X15, scope (0->244)
  ## Scoped Variable "evword" uses Register X17, scope (0->244)
  ## Scoped Variable "label" uses Register X18, scope (0->244)
  ## Scoped Variable "cont_word" uses Register X19, scope (0->244)
  ## Scoped Variable "sp_ptr" uses Register X20, scope (0->244)
  ## Scoped Variable "sp_ptr" uses Register X17, scope (0->247)
  ## Scoped Variable "evw" uses Register X18, scope (0->247)
  ## Scoped Variable "cont" uses Register X19, scope (0->247)
  ## Scoped Variable "sendbuf_lm_ptr" uses Register X17, scope (0->248)
  ## Scoped Variable "sp_ptr" uses Register X18, scope (0->248)
  ## Scoped Variable "list_size" uses Register X19, scope (0->248)
  ## Scoped Variable "list_addr" uses Register X20, scope (0->248)
  ## Scoped Variable "nlanes" uses Register X21, scope (0->248)
  ## Scoped Variable "input_meta_ptr" uses Register X22, scope (0->248)
  ## Scoped Variable "evw" uses Register X23, scope (0->248)
  ## Scoped Variable "cont" uses Register X24, scope (0->248)
  ## Scoped Variable "sp_ptr" uses Register X17, scope (0->250)
  ## Scoped Variable "evw" uses Register X18, scope (0->250)
  ## Scoped Variable "cont" uses Register X19, scope (0->250)
  ## Scoped Variable "sendbuf_lm_ptr" uses Register X17, scope (0->251)
  ## Scoped Variable "sp_ptr" uses Register X18, scope (0->251)
  ## Scoped Variable "list_size" uses Register X19, scope (0->251)
  ## Scoped Variable "list_addr" uses Register X20, scope (0->251)
  ## Scoped Variable "nlanes" uses Register X21, scope (0->251)
  ## Scoped Variable "input_meta_ptr" uses Register X22, scope (0->251)
  ## Scoped Variable "lb_meta_ptr" uses Register X23, scope (0->251)
  ## Scoped Variable "evw" uses Register X25, scope (0->251)
  ## Scoped Variable "cont" uses Register X26, scope (0->251)
  ## Scoped Variable "evword" uses Register X17, scope (0->256)
  ## Scoped Variable "label" uses Register X18, scope (0->256)
  ## Scoped Variable "cont_word" uses Register X19, scope (0->256)
  ## Scoped Variable "sp_ptr" uses Register X20, scope (0->256)
  ## Scoped Variable "sort_ptr" uses Register X21, scope (0->256)
  ## Scoped Variable "sendbuf_lm_ptr" uses Register X17, scope (0->258)
  ## Scoped Variable "sp_ptr" uses Register X18, scope (0->258)
  ## Scoped Variable "list_size" uses Register X19, scope (0->258)
  ## Scoped Variable "list_addr" uses Register X20, scope (0->258)
  ## Scoped Variable "nlanes" uses Register X21, scope (0->258)
  ## Scoped Variable "input_meta_ptr" uses Register X22, scope (0->258)
  ## Scoped Variable "evw" uses Register X23, scope (0->258)
  ## Scoped Variable "cont" uses Register X24, scope (0->258)
  ## Scoped Variable "tot" uses Register X16, scope (0)
  ## Scoped Variable "tot2" uses Register X17, scope (0)
  ## Scoped Variable "offset" uses Register X18, scope (0)
  ## Param "list_size_base" uses Register X8, scope (0->262)
  ## Param "list_addr" uses Register X9, scope (0->262)
  ## Param "tmp_addr" uses Register X10, scope (0->262)
  ## Param "num_lanes_num_bins" uses Register X11, scope (0->262)
  ## Param "use_unique_max_value" uses Register X12, scope (0->262)
  ## Param "list_ptr" uses Register X13, scope (0->262)
  ## Scoped Variable "num_bins" uses Register X19, scope (0->262)
  ## Scoped Variable "num_lanes" uses Register X20, scope (0->262)
  ## Scoped Variable "bins_per_lane" uses Register X21, scope (0->262)
  ## Scoped Variable "sp_ptr" uses Register X22, scope (0->262->264)
  ## Scoped Variable "idx" uses Register X22, scope (0->262->266)
  ## Scoped Variable "rptr" uses Register X23, scope (0->262->266)
  ## Scoped Variable "ptr" uses Register X22, scope (0->262->271)
  ## Scoped Variable "dram_addr" uses Register X23, scope (0->262->271)
  ## Scoped Variable "lm_addr" uses Register X24, scope (0->262->271)
  ## Scoped Variable "evw" uses Register X25, scope (0->262->271)
  ## Scoped Variable "ptr" uses Register X19, scope (0->272)
  ## Scoped Variable "bins_per_lane" uses Register X20, scope (0->272)
  ## Scoped Variable "dram_addr" uses Register X21, scope (0->272)
  ## Scoped Variable "lm_addr" uses Register X22, scope (0->272)
  ## Scoped Variable "evw" uses Register X23, scope (0->272)
  ## Scoped Variable "cval" uses Register X16, scope (0)
  ## Scoped Variable "bin_idx" uses Register X17, scope (0)
  ## Param "key" uses Register X8, scope (0->277)
  ## Param "val" uses Register X9, scope (0->277)
  ## Scoped Variable "evw" uses Register X18, scope (0->277)
  ## Scoped Variable "ptr" uses Register X19, scope (0->277)
  ## Scoped Variable "ikey" uses Register X20, scope (0->277)
  ## Param "key" uses Register X8, scope (0->278)
  ## Param "value" uses Register X9, scope (0->278)
  ## Scoped Variable "ptr" uses Register X18, scope (0->278)
  ## Scoped Variable "evw" uses Register X19, scope (0->278)
  ## Scoped Variable "addone" uses Register X20, scope (0->278)
  ## Param "key" uses Register X8, scope (0->279)
  ## Param "local_bin_count" uses Register X9, scope (0->279)
  ## Scoped Variable "ptr" uses Register X18, scope (0->279)
  ## Scoped Variable "dram_block_size" uses Register X19, scope (0->279)
  ## Scoped Variable "dram_addr" uses Register X20, scope (0->279)
  ## Scoped Variable "tot" uses Register X16, scope (0)
  ...
  ## Param "key" uses Register X8, scope (0->281)
  ## Param "val" uses Register X9, scope (0->281)
  ## Scoped Variable "evw" uses Register X22, scope (0->281)
  ## Scoped Variable "sptr" uses Register X23, scope (0->281)
  ## Scoped Variable "bin_lane_id" uses Register X24, scope (0->281)
  ## Param "ikey" uses Register X8, scope (0->282)
  ## Param "bin_list_size" uses Register X9, scope (0->282)
  ## Param "bin_addr" uses Register X10, scope (0->282)
  ## Scoped Variable "evw" uses Register X22, scope (0->282)
  ## Scoped Variable "sptr" uses Register X23, scope (0->282)
  ## Scoped Variable "bitmap" uses Register X24, scope (0->282)
  ## Scoped Variable "send_buffer" uses Register X25, scope (0->282)
  ## Param "ikey" uses Register X8, scope (0->290)
  ## Param "bin_list_size" uses Register X9, scope (0->290)
  ## Param "bin_addr" uses Register X10, scope (0->290)
  ## Param "ptr" uses Register X11, scope (0->290)
  ## Scoped Variable "sptr" uses Register X22, scope (0->290)
  ## Scoped Variable "bin_id" uses Register X23, scope (0->290)
  ## Scoped Variable "tmp_bin_dram_addr" uses Register X24, scope (0->290)
  ## Scoped Variable "evw" uses Register X25, scope (0->290)
  ## Scoped Variable "send_buffer" uses Register X26, scope (0->290)
  ## Param "ikey" uses Register X8, scope (0->291)
  ## Param "bin_list_size" uses Register X9, scope (0->291)
  ## Param "bin_addr" uses Register X10, scope (0->291)
  ## Param "ptr" uses Register X11, scope (0->291)
  ## Scoped Variable "sptr" uses Register X22, scope (0->291)
  ## Scoped Variable "bin_id" uses Register X23, scope (0->291)
  ## Scoped Variable "tmp_bin_dram_addr" uses Register X24, scope (0->291)
  ## Scoped Variable "evw" uses Register X25, scope (0->291)
  ## Scoped Variable "evw" uses Register X22, scope (0->293->295)
  ## Scoped Variable "cont" uses Register X23, scope (0->293->295)
  ## Scoped Variable "lm_ptr" uses Register X22, scope (0->297)
  ## Scoped Variable "evw" uses Register X23, scope (0->297)
  ## Scoped Variable "evw" uses Register X22, scope (0->299->301)
  ## Scoped Variable "sptr" uses Register X23, scope (0->299->301)
  ## Scoped Variable "bitmap" uses Register X24, scope (0->299->301)
  ## Scoped Variable "evw" uses Register X22, scope (0->303)
  ## Scoped Variable "sptr" uses Register X23, scope (0->303)
  ## Scoped Variable "bitmap" uses Register X24, scope (0->303)
  ## Scoped Variable "tot" uses Register X16, scope (0)
  ## Scoped Variable "bin_size" uses Register X17, scope (0)
  ## Scoped Variable "bin_dram_addr" uses Register X18, scope (0)
  ## Scoped Variable "save_cont" uses Register X19, scope (0)
  ...
  ## Param "val" uses Register X9, scope (0->306)
  ## Scoped Variable "evw" uses Register X22, scope (0->306)
  ## Param "ikey" uses Register X8, scope (0->307)
  ## Param "bin_list_size" uses Register X9, scope (0->307)
  ## Param "bin_addr" uses Register X10, scope (0->307)
  ## Scoped Variable "evw" uses Register X22, scope (0->307)
  ## Scoped Variable "sptr" uses Register X23, scope (0->307)
  ## Scoped Variable "bitmap" uses Register X24, scope (0->307)
  ## Scoped Variable "send_buffer" uses Register X25, scope (0->307)
  ## Param "ikey" uses Register X8, scope (0->315)
  ## Param "bin_list_size" uses Register X9, scope (0->315)
  ## Param "bin_addr" uses Register X10, scope (0->315)
  ## Param "ptr" uses Register X11, scope (0->315)
  ## Scoped Variable "sptr" uses Register X22, scope (0->315)
  ## Scoped Variable "bin_id" uses Register X23, scope (0->315)
  ## Scoped Variable "tmp_bin_dram_addr" uses Register X24, scope (0->315)
  ## Scoped Variable "evw" uses Register X25, scope (0->315)
  ## Scoped Variable "send_buffer" uses Register X26, scope (0->315)
  ## Param "ikey" uses Register X8, scope (0->316)
  ## Param "bin_list_size" uses Register X9, scope (0->316)
  ## Param "bin_addr" uses Register X10, scope (0->316)
  ## Param "ptr" uses Register X11, scope (0->316)
  ## Scoped Variable "sptr" uses Register X22, scope (0->316)
  ## Scoped Variable "bin_id" uses Register X23, scope (0->316)
  ## Scoped Variable "tmp_bin_dram_addr" uses Register X24, scope (0->316)
  ## Scoped Variable "evw" uses Register X25, scope (0->316)
  ## Scoped Variable "evw" uses Register X22, scope (0->318->320)
  ## Scoped Variable "cont" uses Register X23, scope (0->318->320)
  ## Scoped Variable "lm_ptr" uses Register X22, scope (0->322)
  ## Scoped Variable "evw" uses Register X23, scope (0->322)
  ## Scoped Variable "evw" uses Register X22, scope (0->324->326)
  ## Scoped Variable "sptr" uses Register X23, scope (0->324->326)
  ## Scoped Variable "bitmap" uses Register X24, scope (0->324->326)
  ...
  ## Param "key" uses Register X8, scope (0->331)
  ## Param "val" uses Register X9, scope (0->331)
  ## Scoped Variable "evw" uses Register X20, scope (0->331)
  ## Param "ikey" uses Register X8, scope (0->332)
  ## Param "bin_list_size" uses Register X9, scope (0->332)
  ## Param "bin_addr" uses Register X10, scope (0->332)
  ## Scoped Variable "ptr" uses Register X20, scope (0->332)
  ## Scoped Variable "sptr" uses Register X21, scope (0->332)
  ## Scoped Variable "bin_ddr" uses Register X22, scope (0->332)
  ## Scoped Variable "bin_id" uses Register X23, scope (0->332)
  ## Scoped Variable "tmp_bin_dram_addr" uses Register X24, scope (0->332)
  ## Param "nxt_bin_size" uses Register X8, scope (0->333)
  ## Scoped Variable "evw" uses Register X20, scope (0->333)
  ## Param "x" uses Register X8, scope (0->337)
  ## Param "sort_lm_offset" uses Register X8, scope (0->341)
  ## Param "list_size" uses Register X9, scope (0->341)
  ## Param "list_addr" uses Register X10, scope (0->341)
  ## Param "num_lanes" uses Register X11, scope (0->341)
  ## Param "tmp_addr" uses Register X12, scope (0->341)
  ## Param "num_bins" uses Register X13, scope (0->341)
  ## Param "lb_addr" uses Register X14, scope (0->341)
  ## Param "max_value" uses Register X15, scope (0->341)
  ## Scoped Variable "evw" uses Register X16, scope (0->341)
  ## Scoped Variable "cont" uses Register X17, scope (0->341)
  ## Scoped Variable "spPtr" uses Register X18, scope (0->341)
  ## Param "list_addr" uses Register X8, scope (0->342)
  ## Param "list_size" uses Register X9, scope (0->342)
  ## Param "num_lanes" uses Register X10, scope (0->342)
  ## Scoped Variable "evw" uses Register X16, scope (0->342)
  ## Scoped Variable "cont" uses Register X17, scope (0->342)
  ## Scoped Variable "spPtr" uses Register X18, scope (0->342)
  ## Scoped Variable "spPtr" uses Register X16, scope (0->343)
  ...
  tranParallelPrefix__prefix.writeAction(f"addi X23 X24 2048") 
  tranParallelPrefix__prefix.writeAction(f"subi X24 X25 1") 
  tranParallelPrefix__prefix.writeAction(f"sari X25 X23 11") 
  ## print("cur_size = %d", cur_size);
  ...
  tranParallelPrefix__preifx_forward_for.writeAction(f"sli X17 X22 1") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"addi X22 X23 1") 
  ...
  tranParallelPrefix__preifx_forward_for.writeAction(f"addi X21 X23 2048") 
  ...
  tranParallelPrefix__preifx_forward_for.writeAction(f"sri X27 X27 53") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"add X27 X24 X22") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"sari X22 X22 11") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"movir X30 2048") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"print 'offset = %d %d' X19 X30") 
  ...
  tranParallelPrefix__preifx_forward_for.writeAction(f"sli X17 X28 1") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"addi X28 X29 1") 
  ...
  tranParallelPrefix__preifx_forward_for.writeAction(f"sli X28 X29 1") 
  tranParallelPrefix__preifx_forward_for.writeAction(f"addi X29 X30 1") 
  ...
  tranMemcpyLib__memcpy_dram_to_sp.writeAction(f"entry: sub X9 X8 X17") 
  ...
  tranMemcpyLib__memcpy_sp_to_dram.writeAction(f"entry: sub X9 X8 X17") 
  ...
  tranExternalMerger__merge_single.writeAction(f"__if_merge_single_5_post: movir X27 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X27 X27 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X27 X27 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X27 X27 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X27 X27 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X27 X27 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X27 X27 65535") 
  tranExternalMerger__merge_single.writeAction(f"movir X28 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X28 X28 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X28 X28 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X28 X28 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X28 X28 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X28 X28 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X28 X28 65535") 
  ...
  tranExternalMerger__merge_single.writeAction(f"movir X29 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X29 X29 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X29 X29 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X29 X29 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X29 X29 65535") 
  tranExternalMerger__merge_single.writeAction(f"sli X29 X29 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X29 X29 65535") 
  tranExternalMerger__merge_single.writeAction(f"bneu X27 X29 __if_merge_single_11_post") 
  ...
  tranExternalMerger__merge_single.writeAction(f"sli X29 X29 16") 
  tranExternalMerger__merge_single.writeAction(f"ori X29 X29 65535") 
  tranExternalMerger__merge_single.writeAction(f"bneu X28 X29 __if_merge_single_17_post") 
  ...
  tranExternalMerger__write_back_write_ret.writeAction(f"entry: movir X27 0") 
  ...
  tranParallelPrefixPerLane__prefix_forward_per_lane.writeAction(f"sub X0 X25 X16") 
  tranParallelPrefixPerLane__prefix_forward_per_lane.writeAction(f"addi X13 X18 0") 
  tranParallelPrefixPerLane__prefix_forward_per_lane.writeAction(f"sli X16 X25 11") 
  tranParallelPrefixPerLane__prefix_forward_per_lane.writeAction(f"addi X25 X26 2048") 
  ...
  tranParallelPrefixPerLane__prefix_forward_per_lane.writeAction(f"sli X16 X28 11") 
  ...
  tranParallelPrefixPerLane__prefix_forward_per_lane_load_ret.writeAction(f"entry: add X7 X18 X25") 
  tranParallelPrefixPerLane__prefix_forward_per_lane_load_ret.writeAction(f"sli X16 X28 11") 
  ...
  tranParallelPrefixPerLane__prefix_backward_per_lane.writeAction(f"sub X0 X25 X16") 
  tranParallelPrefixPerLane__prefix_backward_per_lane.writeAction(f"addi X13 X18 0") 
  tranParallelPrefixPerLane__prefix_backward_per_lane.writeAction(f"sli X16 X25 11") 
  tranParallelPrefixPerLane__prefix_backward_per_lane.writeAction(f"addi X25 X26 2048") 
  ...
  tranParallelPrefixPerLane__prefix_backward_per_lane.writeAction(f"sli X16 X28 11") 
  ...
  tranParallelPrefixPerLane__prefix_backward_per_lane_load_ret.writeAction(f"sli X16 X28 11") 
  ...
  tranDistributed_sort__sort_phase1_init.writeAction(f"movlr 88(X18) X24 0 8") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"movlr 32(X18) X25 0 8") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"sli X25 X26 3") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"add X24 X26 X27") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"movrl X27 0(X17) 0 8") 
  ## Pointer to the partition array (64-bit DRAM address)
  tranDistributed_sort__sort_phase1_init.writeAction(f"movir X24 1") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"movrl X24 8(X17) 0 8") 
  ...
  tranDistributed_sort__sort_phase1_init.writeAction(f"movir X23 0") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"evlb X23 DistributedSortPhase1::map_shuffle_reduce") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"evi X23 X23 255 4") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"ev X23 X23 X0 X0 8") 
  ## unsigned long cont = evw_update_event(CEVNT, sort_end);
  tranDistributed_sort__sort_phase1_init.writeAction(f"evi X2 X24 Distributed_sort::sort_phase1_post_processing 1") 
  tranDistributed_sort__sort_phase1_init.writeAction(f"send_wcont X23 X24 X17 5") 
  ...
  tranDistributed_sort__sort_phase1_post_processing.writeAction(f"entry: addi X7 X17 20000") 
  ...
  tranDistributed_sort__sort_phase2_init.writeAction(f"evi X25 X25 255 4") 
  tranDistributed_sort__sort_phase2_init.writeAction(f"ev X25 X25 X0 X0 8") 
  tranDistributed_sort__sort_phase2_init.writeAction(f"__if_sort_phase2_init_2_post: evi X2 X26 Distributed_sort::sort_phase3_init 1") 
  ## unsigned long cont = evw_update_event(CEVNT, sort_end);
  ...
  tranDistributed_sort__sort_phase3_init.writeAction(f"movir X23 36640") 
  ...
  tranDistributed_sort_per_lane_thread__sort_init_per_lane.writeAction(f"entry: addi X7 X22 20000") 
  ...
  tranDistributed_sort_per_lane_thread__sort_post_phase1_per_lane_return.writeAction(f"entry: movir X19 0") 
  ...
  tranDistributedSortPhase1__kv_reduce.writeAction(f"print 'getting bin id = %lu, value = %lu, netid = %lu' X17 X9 X0") 
  ...
  tranDistributedSortPhase2__kv_reduce.writeAction(f"movir X26 4000") 
  ...
  tranDistributedSortPhase2__kv_reduce.writeAction(f"muli X21 X28 4000") 
  ...
  tranDistributedSortPhase2__ext_merge_sort.writeAction(f"entry: print 'in ext_merge_sort'") 
  ...
  tranDistributedSortPhase2__ext_merge_sort.writeAction(f"movir X28 4000") 
  ...
  ## unsigned long* local ptr = LMBASE + SORT_OFFSET + VAR_SIZE;
  tranDistributedSortPhase2__local_bin_sort.writeAction(f"entry: addi X7 X22 20000") 
  ...
  ## }
  tranDistributedSortPhase2__local_bin_sort.writeAction(f"perflog 1 0 '[NWID %lu] start sorting bin' X0") 
  ...
  tranDistributedSortPhase2__kv_reduce_load_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] loadfinish sorting bin' X0") 
  ## start a new thread for sort?
  tranDistributedSortPhase2__kv_reduce_load_ret.writeAction(f"evi X2 X22 DistributedSortPhase2LocalSort::init 1") 
  ...
  tranDistributedSortPhase2__kv_reduce_load_ret.writeAction(f"muli X21 X25 4000") 
  ...
  tranDistributedSortPhase2__kv_reduce_sort_ret.writeAction(f"muli X21 X24 4000") 
  ...
  tranDistributedSortPhase2__kv_reduce_sort_ret.writeAction(f"perflog 1 0 '[NWID %lu] sortfinish sorting bin' X0") 
  ...
  tranDistributedSortPhase2__kv_reduce_sort_send_back_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] storefinish sorting bin' X0") 
  tranDistributedSortPhase2__kv_reduce_sort_send_back_ret.writeAction(f"evi X2 X22 DistributedSortPhase2::kv_reduce_return 1") 
  ...
  tranDistributedSortPhase2__kv_reduce_ext_sort_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] end sorting bin' X0") 
  tranDistributedSortPhase2__kv_reduce_ext_sort_ret.writeAction(f"evi X2 X22 DistributedSortPhase2::kv_reduce_return 1") 
  ...
  ## print("ikey = %d", ikey);
  ## send_event(evw, val, key, val, CCONT);
  tranDistributedSortPhase2Lb__kv_map.writeAction(f"sari X9 X23 3") 
  tranDistributedSortPhase2Lb__kv_map.writeAction(f"sendr3_wcont X22 X1 X23 X8 X9") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce.writeAction(f"movir X26 4000") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce.writeAction(f"muli X21 X28 4000") 
  ...
  tranDistributedSortPhase2Lb__ext_merge_sort.writeAction(f"entry: print 'in ext_merge_sort'") 
  ## unsigned long* local ptr = LMBASE + SORT_OFFSET + VAR_SIZE;
  ...
  ## unsigned long bk_size = SP_BLOCKSIZE;
  tranDistributedSortPhase2Lb__ext_merge_sort.writeAction(f"movir X28 4000") 
  ...
  ## unsigned long* local ptr = LMBASE + SORT_OFFSET + VAR_SIZE;
  tranDistributedSortPhase2Lb__local_bin_sort.writeAction(f"entry: addi X7 X22 20000") 
  ...
  ## 	bin_dram_addr = bin_dram_addr + 8;
  ## }
  tranDistributedSortPhase2Lb__local_bin_sort.writeAction(f"perflog 1 0 '[NWID %lu] start sorting bin' X0") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce_load_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] loadfinish sorting bin' X0") 
  ## start a new thread for sort?
  tranDistributedSortPhase2Lb__kv_reduce_load_ret.writeAction(f"evi X2 X22 DistributedSortPhase2LocalSort::init 1") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce_load_ret.writeAction(f"muli X21 X25 4000") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce_sort_ret.writeAction(f"muli X21 X24 4000") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce_sort_ret.writeAction(f"perflog 1 0 '[NWID %lu] sortfinish sorting bin' X0") 
  ## for (tot = 0; tot < bin_size; tot = tot + 1) {
  ## 	send_dram_write(bin_dram_addr, lm_ptr, 1, kv_reduce_sort_send_back_ret);
  ## 	bin_dram_addr = bin_dram_addr + 8;
  ## 	lm_ptr = lm_ptr + 8;
  ...
  ## print("sended back sorted bin to dram: %lu, bin_size = %lu", bin_dram_addr, bin_size);
  tranDistributedSortPhase2Lb__kv_reduce_sort_send_back_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] storefinish sorting bin' X0") 
  tranDistributedSortPhase2Lb__kv_reduce_sort_send_back_ret.writeAction(f"evi X2 X22 DistributedSortPhase2Lb::kv_reduce_return 1") 
  ...
  tranDistributedSortPhase2Lb__kv_reduce_ext_sort_ret.writeAction(f"entry: perflog 1 0 '[NWID %lu] end sorting bin' X0") 
  tranDistributedSortPhase2Lb__kv_reduce_ext_sort_ret.writeAction(f"evi X2 X22 DistributedSortPhase2Lb::kv_reduce_return 1") 
  ...
  tranSortingTest__test_parallel_prefix.writeAction(f"movir X20 17984") 
